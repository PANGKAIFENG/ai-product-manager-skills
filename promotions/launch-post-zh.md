...
它是一个中文优先的 AI Product Manager Skills Library，目前包含 11 个公开 Skill：
...
产品问题校准 -> 主题研究 -> 决策调研 -> 方案脑暴 -> PRD 起草 -> PRD 评审 -> PRD 拆 issue -> UI 结构线框 -> 高保真 UI handoff / 方案压测 -> 交给 Superpowers 做开发计划。
