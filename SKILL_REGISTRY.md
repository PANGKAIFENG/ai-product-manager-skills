...
| `x-public-signal-research` | X 公开信号研究 / X 舆情与产品信号研究 | “用 X 看看用户怎么说”“查一下这个竞品在 Twitter 上的反馈”“分析 launch 后的 X 讨论” | 用 Xquik 把 X/Twitter 公开内容转成用户痛点、竞品声量、launch 反馈、PRD 证据或产品决策输入。 | 泛泛全网研究；完整竞品决策简报；最终选型；社媒发布、私密读取、monitor、webhook 或 bulk work 未获批准。 | active |
