...
| `brainstorming` | 设计脑暴 / 实现前方案校准 | “先脑暴一下方案”“先不要写 PRD，帮我设计几种路径”“参考 brainstorming 把这个需求变成设计 spec” | 问题基本成立，但在写 PRD、画 mockup 或进入开发计划前，还需要一问一答澄清关键缺口、比较 2-3 个方案、确认设计取舍并输出设计 spec。 | 问题还没定义清楚；已有方案要压力测试；直接写 PRD；直接实现代码。 | core |
