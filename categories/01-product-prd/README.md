...
用于把需求从想法、草稿或评审意见推进到可交付的产品文档。

## Skills

| Skill | 中文名 | 可以这样说 | 状态 | 用途 |
| --- | --- | --- | --- | --- |
| [`concept-lens-dashboard`](../../concept-lens-dashboard/) | 概念透镜看板 / 高阶概念解构 | “帮我解构一个概念”“做行业演进看板” | active | 生成带来源、可验证的概念源流、语义演化、PM 概念演进矩阵与 HTML 决策看板。 |
